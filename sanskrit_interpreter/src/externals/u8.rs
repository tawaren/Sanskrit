...
pub const MODULE:Hash = [190, 180, 38, 200, 248, 85, 8, 133, 170, 39, 202, 121, 15, 173, 252, 60, 218, 80, 245, 132];
pub const EXT_U8:&'static dyn External = &U8;

pub fn check_hash() {
    assert_eq!(format!("{:?}", MODULE), include_str!("../../../sanskrit_test/scripts/out/intu8.hash"));
}

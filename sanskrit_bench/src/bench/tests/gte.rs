...
pub struct GteTest(usize,Kind,isize);
impl Op for GteTest {
...
lazy_static! {
    pub static ref MEASURE_CACHE: Mutex<BTreeMap<OpTest<GteTest>, u128>> = Mutex::new(BTreeMap::new());
}

fn measure(test:OpTest<GteTest>, loops:usize) -> u128 {
